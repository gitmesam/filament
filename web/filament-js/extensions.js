...
Filament.loadClassExtensions = function() {
    ...
    Filament.gltfio$AssetLoader.prototype.createAssetFromGlb = function(buffer) {
        buffer = getBufferDescriptor(buffer);
        const result = this._createAssetFromGlb(buffer);
        buffer.delete();
        return result;
    };
    ...
    //
    // "Finalization" in this context refers to decoding texture data, converting the format of the
